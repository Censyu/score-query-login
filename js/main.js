...
$(document).ready(function () {
    ...
    if (id) {
        ...
        ajaxURL = "http://[proper url here]/score/" + id
        loadAnim(true);
        $.ajax({
            url: ajaxURL,
...
var serviceURL = "proper service url";
var apiURL = "proper api url";
...
//    $(".toast .toast-body").text(msg);
    $(".toast .toast-body").html(msg + '<a href="http://[proper url here]">重新登录</a>');
    $(".toast").toast('show');
    setTitle("Error!");
}
